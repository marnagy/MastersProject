public class MaxElitismCombination<T> : PopulationCombinationStrategy<T> where T: Chromosome<T>
{
    private int BestAmount;
    private int NewIndividuals;
    private Fitness<T> Fitness;
    private Func<T> CreateNewChromosome;
    public MaxElitismCombination(int bestAmount, int newIndividuals, Fitness<T> fitnessFunc, Func<T> createNewChrom)
    {
